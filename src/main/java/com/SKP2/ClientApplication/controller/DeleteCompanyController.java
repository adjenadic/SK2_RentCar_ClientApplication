...
public class DeleteCompanyController implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        btnDelete.addActionListener(event -> {
            try {
                if (MainFrame.getInstance().getRentalService().deleteCompany(Long.parseLong(tfID.getText()))) {
                    JOptionPane.showMessageDialog(null, "Company " + tfID.getText() + " successfully deleted.", "Operation successful", JOptionPane.INFORMATION_MESSAGE);
                } else {
